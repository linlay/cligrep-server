...
CREATE TABLE IF NOT EXISTS cli_registry (
  ...
  OFFICIAL_URL_ VARCHAR(512) NOT NULL DEFAULT '',
  ...
  OWNER_USER_ID_ BIGINT UNSIGNED NULL,
  ...
  KEY IDX_CLI_REGISTRY_OWNER_STATUS (OWNER_USER_ID_, STATUS_)
...
CREATE TABLE IF NOT EXISTS cli_release_asset (
  ...
  STORAGE_KIND_ VARCHAR(64) NOT NULL DEFAULT '',
  STORAGE_PATH_ VARCHAR(1024) NOT NULL DEFAULT '',
  CREATED_AT_ DATETIME(3) NOT NULL,
  PRIMARY KEY (ID_),
